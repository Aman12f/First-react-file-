...
// style={{backgroundColor: props.mode==='dark'?'#0d143a':'white'
const About1 = (props) => {
  return (
   <>
   ...
   <div className="accordion" id="accordionExample">
      <strong style={{color:props.mode === 'dark'?'white':'black'}}>About Us</strong>
  <div className={`accordion-item bg-${props.mode}`}style={{color:props.mode==='light'?'black':'white'}}>
